...
foreach (i = seq(length(comb_elev_res@meta$input$RESPONSE)), .packages = c("gpm", "caret", "pls", "CAST")) %dopar% {
  ...
  saveRDS(model, file = paste0(path_model_gpm_sr_elev_res, 
                               "ki_sr_elui_non_scaled_elev_res_pls_", 
                               model@meta$input$RESPONSE_FINAL, 
                               ".rds"))
}
...
foreach (i = seq(length(comb_elev_res@meta$input$RESPONSE)), .packages = c("gpm", "caret", "pls", "CAST")) %dopar% {
  ...
  saveRDS(model, file = paste0(path_model_gpm_sr_elev_res, 
                               "ki_sr_spec_non_scaled_elev_res_pls_", 
                               model@meta$input$RESPONSE_FINAL, 
                               ".rds"))
}
...
foreach (i = seq(length(comb_elev_res@meta$input$RESPONSE)), .packages = c("gpm", "caret", "pls", "CAST")) %dopar% {
  ...
  saveRDS(model, file = paste0(path_model_gpm_sr_elev_res, 
                               "ki_sr_elsp_non_scaled_elev_res_pls_", 
                               model@meta$input$RESPONSE_FINAL, 
                               ".rds"))
}
...
foreach (i = seq(length(comb_elev_res@meta$input$RESPONSE)), .packages = c("gpm", "caret", "pls", "CAST")) %dopar% {
  ...
  saveRDS(model, file = paste0(path_model_gpm_sr_elev_res, 
                               "ki_sr_kmra_non_scaled_elev_res_pls_", 
                               model@meta$input$RESPONSE_FINAL, 
                               ".rds"))
}
...
foreach (i = seq(length(comb_elev_res@meta$input$RESPONSE)), .packages = c("gpm", "caret", "mgcv", "CAST")) %dopar% {
  ...
  saveRDS(model, file = paste0(path_model_gpm_sr_elev_res, 
                               "ki_sr_elui_non_scaled_elev_res_gam_", 
                               model@meta$input$RESPONSE_FINAL, 
                               ".rds"))
}
...
foreach (i = seq(length(comb_elev_res@meta$input$RESPONSE)), .packages = c("gpm", "caret", "mgcv", "CAST")) %dopar% {
  ...
  saveRDS(model, file = paste0(path_model_gpm_sr_elev_res, 
                               "ki_sr_elsp_non_scaled_elev_res_gam_", 
                               model@meta$input$RESPONSE_FINAL, 
                               ".rds"))
}
...
foreach (i = seq(length(comb_elev_res@meta$input$RESPONSE)), .packages = c("gpm", "caret", "mgcv", "CAST")) %dopar% {
  ...
  saveRDS(model, file = paste0(path_model_gpm_sr_elev_res, 
                               "ki_sr_kmra_non_scaled_elev_res_gam_", 
                               model@meta$input$RESPONSE_FINAL, 
                               ".rds"))
}
