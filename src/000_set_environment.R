...
path_comb_gpm_sr_res = paste0(path_data, "/300_comb_gpm_sr_res/")
path_model_gpm_sr_res = paste0(path_data, "/310_model_gpm_sr_res/")
path_compile_analysis_sr = paste0(path_data, "/400_compile_analysis_sr/")
path_compile_analysis_sr_elev_res = paste0(path_data, "/410_compile_analysis_sr_elev_res/")
