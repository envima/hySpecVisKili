...
setwd("/media/sd19006/data/users/iotte/R-Server/hyperspectral/clean/2nd/norm_441/re_norm/pca/pca_inverse/pca_inverse_dia_50m/")
filepath_raster <- "/media/sd19006/data/users/iotte/R-Server/hyperspectral/clean/2nd/norm_441/re_norm/pca/pca_inverse/pca_inverse_dia_50m/"
...
write.csv2(dist.plts.all, 
           file = "pci_dia_50m_sd_distCent_2nd.csv", 
           row.names = FALSE)
